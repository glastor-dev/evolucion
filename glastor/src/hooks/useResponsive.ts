...
export function useResponsiveClasses() {
  ...
  const getResponsiveClass = (classes: {
    ...
    if ((breakpoint === '2xl' || breakpoint === 'xl' || breakpoint === 'lg') && classes.lg) return classes.lg;
    if ((breakpoint === '2xl' || breakpoint === 'xl' || breakpoint === 'lg' || breakpoint === 'md') && classes.md) return classes.md;
