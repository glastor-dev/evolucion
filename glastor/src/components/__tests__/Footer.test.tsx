...
describe('Footer', () => {
  ...
  it('should display navigation links', () => {
    ...
    expect(inicioLinks.length > 0 || productosLinks.length > 0 || contactoLinks.length > 0).toBeTruthy();
  });
  ...
  it('should display business hours if present', () => {
    ...
    const businessHours = screen.queryByText(/horarios/i) || 
  ...
  it('should display address information', () => {
    ...
    const address = screen.queryByText(/dirección/i) ||
  ...
  it('should display copyright information', () => {
    ...
    const copyright = screen.getByText(new RegExp(`© ${currentYear} GLASTOR`)) ||
  ...
  it('should display payment methods if present', () => {
    ...
    const paymentInfo = screen.queryByText(/pago/i) ||
  ...
  it('should display shipping information if present', () => {
    ...
    const shippingInfo = screen.queryByText(/envío/i) ||
  ...
  it('should have working email link', async () => {
    ...
    const emailLink = screen.queryByRole('link', { name: /email/i }) ||
  ...
  it('should display legal links if present', () => {
    ...
    const legalLinks = screen.queryByText(/términos/i) ||
